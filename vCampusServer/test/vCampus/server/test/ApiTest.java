...
public class ApiTest {
    ...
    public void testRegisterAndUnRegister() {
        ...
        res = Api.post("/account", JSON.toJSONString(newAccount));
        expectedRes = new HttpResponse("403", null, "Account already exist.");
        ...
        // 测试注销一个不存在的账户
        res = Api.delete("/account/campusCardID/213170002");
        expectedRes = new HttpResponse("404", null, "Account not found.");
    ...
    public void testStuInfo() {
        ...
        // 403 Forbidden
        res = Api.post("/stuInfo", JSON.toJSONString(newStuInfo));
        expectedRes = new HttpResponse("403", null, "StuInfo already exist.");
        ...
        expectedRes = new HttpResponse("200", "omiited", "OK");

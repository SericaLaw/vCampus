define({ "api": [
  ...
  },
  {
    "group": "Course",
    "type": "patch",
    "url": "/courseSchedule/id/{uuid}",
    "title": "ModifyCourseSchedule",
    "permission": [
      {
        "name": "teacher"
      }
    ],
    "description": "<p>修改课程安排</p>",
    "parameter": {
      "examples": [
        {
          "title": "Code Snippets",
          "content": "CourseScheduleViewModel schedule = ...\n\nString uuid = schedule.getId();\nschedule.set...;\nWebResponse res = api.patch(\"/course/record/\" + uuid, JSON.toJSONString(schedule);",
          "type": "json"
        }
      ]
    },
    ...
    "filename": "vCampus/vCampusServer/src/main/java/team/yummy/vCampus/server/api/CourseController.java",
    "groupTitle": "Course",
    "name": "PatchCoursescheduleIdUuid"
  },
  {
    "group": "Course",
    "type": "post",
    ...
    "description": "<p>创建课程，需要在Course表和CourseSchedule表里增加条目</p>",
    "parameter": {
      "examples": [
        {
          "title": "Code Snippets",
          "content": "WebResponse res = api.post(\"/course/new\", JSON.toJSONString(courseRegisterViewModel));",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    ...
    "parameter": {
      "examples": [
        {
          "title": "Code Snippets",
          "content": "WebResponse res = api.get(\"/stuInfo/gpa\");",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    ...
    "type": "get",
    "url": "/teacher/course",
    "title": "GetTeacherCourseSchedule",
    "permission": [
      {
        "name": "teacher"
      }
    ],
    "description": "<p>根据ProfCampusCardId获取教师任教的课程表</p>",
    "parameter": {
      "examples": [
        {
          "title": "Code Snippets",
          "content": "WebResponse res = api.get(\"/course/teacher\");\nList<CourseScheduleViewModel> schedules = res.dataList(CourseScheduleViewModel.class);",
          "type": "json"
        }
      ]
    },
    ...
    "version": "0.0.0",
    "filename": "vCampus/vCampusServer/src/main/java/team/yummy/vCampus/server/api/TeacherController.java",
    "groupTitle": "Teacher",
  ...
  },
  {
    ...
    "type": "get",
    "url": "/teacher/record",
    "title": "GetCourseRecord",
    "permission": [
      {
        "name": "teacher"
      }
    ],
    "description": "<p>获取任教课程对应学生的CourseReport列表</p>",
    "parameter": {
      "examples": [
        {
          "title": "Code Snippets",
          "content": "WebResponse res = api.get(\"/teacher/record\");\nList<TeacherCourseReportViewModel> reportList = res.dataList(TeacherCourseReportViewModel.class);",
          "type": "json"
        }
      ]
    },
